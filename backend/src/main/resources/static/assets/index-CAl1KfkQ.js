...
function R1() {
  ...
  (Ml.constructor = zt), Bl(Ml, Xl.prototype), (Ml.isPureReactComponent = !0);
  var dt = Array.isArray,
    L = { H: null, A: null, T: null, S: null, V: null },
    Vl = Object.prototype.hasOwnProperty;
  function Ll(s, E, _, z, N, K) {
    return (
      (_ = K.ref),
  ...
  function Ul(s, E, _, z, N) {
    ...
    if (dt(s))
      for (var fl = 0; fl < s.length; fl++)
        (z = s[fl]), (K = Jl + Dl(z, fl)), (G += Ul(z, E, _, K, N));
    else if (((fl = al(s)), typeof fl == "function"))
      for (s = fl.call(s), fl = 0; !(z = s.next()).done; )
        (z = z.value), (K = Jl + Dl(z, fl++)), (G += Ul(z, E, _, K, N));
    else if (K === "object") {
            ...
            return (
              ...
              B > tl
                ? ((g.sortIndex = B),
                  ...
                  $(H) === null &&
                    g === $(A) &&
                    (yt ? (zt(Ll), (Ll = -1)) : (yt = !0), Ul(L, B - tl)))
                : ((g.sortIndex = s),
                  il(H, g),
                  Bl || Yl || ((Bl = !0), Vl || ((Vl = !0), Dl()))),
              g
            );
          }),
...
function B1() {
  ...
  function Se(l) {
    K.current === l && (_(N), _(K)),
      Jl.current === l && (_(Jl), (ve._currentValue = B));
  }
  ...
  var Ct = Math.random().toString(36).slice(2),
    ...
    Ea = "__reactMarker$" + Ct;
  function jn(l) {
    delete l[Rl], delete l[Ql], delete l[Zn], delete l[Sy], delete l[gy];
  }
  function Bu(l) {
    var t = l[Rl];
    if (t) return t;
...
` +
  ...
  function Od(l, t, u) {
    ...
    (u = {
      ...
      Fe(l)
        ? P0(t, u)
        : ((u = hf(l, t, u, a)), u !== null && (tt(u, l, a), ls(u, t, a)));
  }
  function I0(l, t, u) {
    var a = lt();
    Ja(l, t, u, a);
  ...
  function es(l) {
    ...
    function m(y, v, d, b, M) {
      ...
      if (typeof b == "object" && b !== null) {
        ...
        if (Ul(b) || Dl(b)) return (y = y.get(d) || null), S(v, y, b, M, null);
      ...
      return (
        ...
        t !== null
          ? ((t.flags & 65536) === 0 && (t.flags |= 256),
            (t.flags |= 65536),
            (t.lanes = e),
            a !== bf && ((l = Error(r(422), { cause: a })), Ba(et(l, u))))
          : (a !== bf && ((t = Error(r(423), { cause: a })), Ba(et(t, u))),
    ...
    if (
      ...
      if (n)
        ...
        if (
          ...
          throw ((i.retryLane = a), wu(l, a), tt(f, l, a), ms);
        ...
        l: {
          ...
          if (
            ...
            if (
              ...
              (e = et(Error(r(424)), t)), Ba(e), (t = zs(l, t, a, u));
              break l;
            } else {
    ...
    switch ((gf(t), t.tag)) {
      ...
      case 27:
        ...
        if (l !== null && t.stateNode != null) l.memoizedProps !== a && pt(t);
          ...
          (l = N.current),
            qa(t) ? e0(t) : ((l = Uv(e, a, u)), (t.stateNode = l), pt(t));
        }
        return sl(t), null;
      case 5:
      ...
      if (e === 0) {
        ...
        l: {
          ...
          if ((t & 62914560) === t && ((e = rc + 300 - St()), 10 < e)) {
            ...
            a.timeoutHandle = Ov(
              ks.bind(null, a, u, Cl, yn, mc, t, st, Hu, ia, lu, n, 2, -0, 0),
              e
            );
            break l;
          }
          ks(a, u, Cl, yn, mc, t, st, Hu, ia, lu, n, 0, -0, 0);
        }
      }
      break;
    } while (!0);
  ...
  function Tc() {
    if (j !== null) {
      if (F === 0) var l = j.return;
      else (l = j), (Ht = Ou = null), Xf(l), (aa = null), (wa = 0), (l = j);
      ...
      t === Qa || t === Ce
        ...
        : (F =
            t === ms
              ...
              : 1),
      (Pl = t),
      j === null && ((yl = 1), an(l, et(t, l.current)));
  }
  function Is() {
    var l = g.H;
  ...
  function tv(l) {
    ...
    switch (t.tag) {
      ...
      case 5:
        Xf(t);
      default:
        Rs(u, t), (t = j = u0(t, Qt)), (t = Ds(u, t, Qt));
    }
    (l.memoizedProps = l.pendingProps), t === null ? hn(l) : (j = t);
  }
  function da(l, t, u, a) {
    ...
    try {
      if (Md(l, e, t, u, V)) {
        (yl = 1), an(l, et(u, l.current)), (j = null);
        return;
      }
    } catch (n) {
...
var G1 = p1();
const X1 = "/assets/react-CHdo91hT.svg",
  Q1 = "/vite.svg";
function x1() {
  const [D, il] = ey.useState(0);
  return Gl.jsxs(Gl.Fragment, {
    children: [
      Gl.jsxs("div", {
        children: [
          Gl.jsx("a", {
      ...
      Gl.jsxs("div", {
        ...
        children: [
          ...
          Gl.jsxs("p", {
            children: [
              "Edit ",
              Gl.jsx("code", { children: "src/App.tsx" }),
...
G1.createRoot(document.getElementById("root")).render(
  Gl.jsx(ey.StrictMode, { children: Gl.jsx(x1, {}) })
);
